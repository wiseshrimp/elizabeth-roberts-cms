  ...
  fields: [
    {
      ...
      description:
        "Optional – Adding a reference will automatically load the reference's main image as the gallery image and link to the reference's page. If you want to add a custom image or link, add below.",
      type: 'reference',
      to: [
        {
          type: 'project',
